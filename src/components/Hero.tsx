        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="space-y-6 md:space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
              <button className="group bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-500 hover:to-purple-400 text-white px-6 md:px-8 py-3 md:py-4 rounded-lg font-semibold text-base md:text-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-2">
                <span>Abra sua conta agora</span>
                <ArrowRight className="w-4 h-4 md:w-5 md:h-5 group-hover:translate-x-1 transition-transform" />
              </button>
              
              <button className="border border-purple-500 text-purple-400 hover:bg-purple-500/10 px-6 md:px-8 py-3 md:py-4 rounded-lg font-semibold text-base md:text-lg transition-all duration-300 hover:border-purple-400">
                Integrar Gateway
              </button>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 md:gap-8 pt-6 md:pt-8">
              ...
              <div className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-white mb-1">R$ 2B+</div>
          ...
          <div className="relative order-first lg:order-last">
            <div className="relative z-10">
              {/* Phone Mockup */}
              <div className="mx-auto w-64 h-80 md:w-80 md:h-96 bg-gradient-to-b from-gray-900 to-gray-800 rounded-3xl p-2 shadow-2xl border border-gray-700">
            ...
            {/* Floating Icons */}
            <div className="absolute top-6 md:top-10 -left-6 md:-left-10 animate-bounce delay-300">
            ...
            <div className="absolute bottom-6 md:bottom-10 -right-6 md:-right-10 animate-bounce delay-700">
              <div className="w-12 h-12 md:w-16 md:h-16 bg-purple-500/20 border border-purple-500/30 rounded-full flex items-center justify-center backdrop-blur-sm">

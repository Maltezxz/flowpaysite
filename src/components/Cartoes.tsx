      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 md:mb-16">
          <div className="inline-flex items-center space-x-2 bg-purple-500/20 border border-purple-500/30 rounded-full px-3 md:px-4 py-1.5 md:py-2 text-xs md:text-sm mb-4 md:mb-6">
            <CreditCard className="w-3 h-3 md:w-4 md:h-4 text-purple-400" />
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-12 md:mb-16">
          {cardBenefits.map((benefit, index) => (
            <div 
              key={index} 
              className="group text-center p-4 md:p-6 bg-gray-900/50 border border-gray-700 rounded-2xl hover:border-purple-500/50 hover:bg-purple-500/5 transition-all duration-300 hover:-translate-y-2"
            >
              <div className="text-purple-400 mb-4 flex justify-center group-hover:scale-110 transition-transform duration-300">
                {benefit.icon}
              </div>
              <h3 className="text-base md:text-lg font-semibold mb-2 text-white group-hover:text-purple-300 transition-colors">
                {benefit.title}
              </h3>
              <p className="text-gray-400 text-xs md:text-sm group-hover:text-gray-300 transition-colors">
                {benefit.description}
              </p>
            </div>
          ))}

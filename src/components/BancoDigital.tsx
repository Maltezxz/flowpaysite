...
const BancoDigital = () => {
  ...
  return (
    <section id="banco" className="py-20 bg-gradient-to-b from-black to-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
          ...
          <div className="relative">
            <div className="mx-auto w-80 h-[600px] bg-gradient-to-b from-gray-900 to-gray-800 rounded-3xl p-3 shadow-2xl border border-gray-700">
        ...
        {/* CTA */}
        <div className="text-center">
          <button className="bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-500 hover:to-purple-400 text-white px-12 py-4 rounded-lg font-semibold text-xl transition-all duration-300 transform hover:scale-105 mb-4">

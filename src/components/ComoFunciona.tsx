...
const ComoFunciona = () => {
  ...
  return (
    <section className="py-12 md:py-20 bg-gradient-to-b from-gray-900 to-black text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 md:mb-20">
          <div className="text-center mb-8 md:mb-12">
            <div className="inline-flex items-center space-x-2 bg-purple-500/20 border border-purple-500/30 rounded-full px-3 md:px-4 py-1.5 md:py-2 text-xs md:text-sm mb-3 md:mb-4">
              <User className="w-3 h-3 md:w-4 md:h-4 text-purple-400" />
              <span className="text-purple-300">Para Pessoas Físicas</span>
            </div>
            <h3 className="text-2xl md:text-3xl font-bold">Abra sua conta em 4 passos simples</h3>
          </div>
        ...
        <div className="mb-16">
          <div className="text-center mb-8 md:mb-12">
            <div className="inline-flex items-center space-x-2 bg-blue-500/20 border border-blue-500/30 rounded-full px-3 md:px-4 py-1.5 md:py-2 text-xs md:text-sm mb-3 md:mb-4">
              <Building className="w-3 h-3 md:w-4 md:h-4 text-blue-400" />
              <span className="text-blue-300">Para Empresas</span>
            </div>
            <h3 className="text-2xl md:text-3xl font-bold">Integre o gateway em 4 etapas</h3>
          </div>
